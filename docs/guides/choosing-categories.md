...
- Moving money between your own accounts (when only one is tracked in Bijoy.ai)
...
If both your accounts are tracked in Bijoy.ai, ideally you'd link the two sides of an internal transfer so they net to zero — but if only one side is in Bijoy.ai, `Sent Domestic` (or its International cousin) is correct.
...
- Bijoy.ai-in-the-classroom deployments where teachers help students track money received

...
If no exact match, Bijoy.ai computes a vector embedding (Gemini, 768 dimensions) and queries pgvector for cosine similarity against your previous classifications. Threshold: `reviewThreshold` (default 0.70).

...
This is the user-facing web application for the Bijoy.ai platform. It is a rich, single-page application (SPA) built with React and Vite, providing a comprehensive and interactive experience for users to manage their finances.
